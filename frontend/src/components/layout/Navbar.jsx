...
function UserMenu({ user, onLogout }) {
  ...
  return (
    <div className="relative" ref={ref}>
      <button
        onClick={() => setOpen((v) => !v)}
        className={`flex items-center gap-2.5 px-3 py-1.5 rounded-xl border transition-colors ${open ? 'border-hack-cyan/40 bg-hack-cyan/5' : 'border-hack-border bg-hack-surface hover:border-hack-border/80'}`}
      >
